        ...
        <div class="container">
            ...
            <div class="row" style="text-align: left;">
                <p style="text-indent: 2em;">
                    Listed below please find your variation query result(s) from FlyVar.
                </p>
            </div>
            <div class="row" style="text-align: left;">
                <p style="text-indent: 2em;">
            ...
            <div class="row" style="text-align: left;">
                <p style="text-indent: 2em;">
                    Click the links to download query results:
                    <ul>
                    <#if queryResult??>
                        <li><a href="${flyvarUrl}/query/result/${queryResult}">query result</a></li>
                    </#if>
                    </ul>
                </p>
            </div>
