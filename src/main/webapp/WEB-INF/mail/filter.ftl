        ...
        <div class="container">
            ...
            <div class="row" style="text-align: left;">
                <p style="text-indent: 2em;">
                    Listed below please find your variation filter result(s) from FlyVar.
                </p>
            </div>
            <div class="row" style="text-align: left;">
                <p style="text-indent: 2em;">
            ...
            <div class="row" style="text-align: left;">
                <p style="text-indent: 2em;">
                    Click the links to download filter results:
                    <ul>
                    <#if filterResult??>
                        <li><a href="${flyvarUrl}/filter/result/${filterResult}">filter result</a></li>
                    </#if>
                    </ul>
                </p>
            </div>
